...
class featureGenerationNet2(nn.Module): # message passing version
    ...
    """
    def __init__(self, raw_feature_size, gcn_hidden_layer_sizes=[4, 7, 10, 16], nn_hidden_layer_sizes=[64, 32]):
...
class GCNPredictionNet2(nn.Module):
    ...
    def __init__(self, raw_feature_size, gcn_hidden_layer_sizes=[16, 10, 7, 4], nn_hidden_layer_sizes=[64, 32]):
