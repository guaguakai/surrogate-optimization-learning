...
def return_yaxis(file):
    ...
    unique_epochs=[int(item) for item in (list(set(matrix[:,1]))) if len(item)<=3]
    print (unique_epochs)
...
if __name__=='__main__':
    ...
    file1="./results/random/0728adi_decision-focused_n20_p0.3_b2.0_global.csv"
    file2="./results/random/0728adi_decision-focused_n20_p0.3_b2.0_mincut.csv"
    file3="./results/random/0728adi_two-stage_n20_p0.3_b2.0_global.csv"
    file4="./results/random/0728adi_two-stage_n20_p0.3_b2.0_mincut.csv"
